...
SYSTEM_PROMPT = (
    ...
    "   To DELETE a section entirely (remove it from the config file), include the section header commented out plus the special marker param #_action: delete like this:\n"
    "   ```\n"
    "   #[extruder]\n"
    "   #_action: delete\n"
    "   ```\n"
    "   The #_action param (underscore-prefixed) is not a real Klipper setting — it signals \"delete this section.\" Without #_action: delete, a commented-out header is treated as a normal comment-out/disable.\n"
